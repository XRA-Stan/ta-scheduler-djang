...
class Section(models.Model):
    ...
    Day_Of_Week = models.CharField(choices=daysOfWeek, max_length=1, default='1')
...
class Course(models.Model):
    ...
    sections = models.ForeignKey(Section, on_delete=models.CASCADE, related_name="courses", null=True)
