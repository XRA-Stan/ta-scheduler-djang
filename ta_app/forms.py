...
class SectionForm(forms.ModelForm):
    ...
    class Meta:
        model = Section
        fields = ['sectionName', 'Day_Of_Week', 'teaching_assistant', 'timeOfDay']
        widgets = {
            'sectionName': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter section name'}),
            'Day_Of_Week': forms.Select(choices=daysOfWeek, attrs={'class': 'form-control'}),
...
class SectionAdminForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['sectionName', 'Day_Of_Week', 'teaching_assistant', 'timeOfDay']
        widgets = {
            'Day_Of_Week': forms.RadioSelect(choices=daysOfWeek),
